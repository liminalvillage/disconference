...
client.on('message', msg => {
   ...
   // console.log(msg.content[0], msg.content[1], msg.content[3])
    ...
    let topic = msg.content.splice(msg.content.indexOf( msg.content.split(" ")[2] ))
    console.log (user + " has scheduled " + topic + "at " + time)
    msg.channel.send(user + " has scheduled " + topic + "at " + time)
    .catch(error => {
      console.log(error);
    });
	}
